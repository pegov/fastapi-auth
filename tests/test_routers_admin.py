...
from fastapi_auth.routers import get_admin_router
...
def test_get_blacklist():
    ...
    with mock.patch(
        "fastapi_auth.routers.admin.AdminService.get_blacklist",
...
def test_toggle_blacklist():
    ...
    with mock.patch(
        "fastapi_auth.routers.admin.AdminService.toggle_blacklist",
        mock.AsyncMock(return_value=None),
    ) as mock_method:
...
def test_get_blackout():
    ...
    with mock.patch(
        "fastapi_auth.routers.admin.AdminService.get_blackout",
        mock.AsyncMock(return_value=None),
    ) as mock_method:
        response = test_client.get(url)
        mock_method.assert_awaited_once()
...
def test_set_blackout():
    ...
    with mock.patch(
        "fastapi_auth.routers.admin.AdminService.set_blackout",
        mock.AsyncMock(return_value=None),
    ) as mock_method:
        response = test_client.post(url)
        mock_method.assert_awaited_once()
...
def test_delete_blackout():
    ...
    with mock.patch(
        "fastapi_auth.routers.admin.AdminService.delete_blackout",
        mock.AsyncMock(return_value=None),
    ) as mock_method:
...
def test_get_id_by_username():
    ...
    with mock.patch(
        "fastapi_auth.routers.admin.AdminService.get_id_by_username",
        mock.AsyncMock(return_value=None),
    ) as mock_method:
...
def test_kick():
    ...
    with mock.patch(
        "fastapi_auth.routers.admin.AdminService.kick",
        mock.AsyncMock(return_value=None),
    ) as mock_method:
        response = test_client.post(url)
        mock_method.assert_awaited_once_with(5)
