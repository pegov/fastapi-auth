...
from fastapi_auth.routers import get_password_router
...
def test_forgot_password():
    ...
    with mock.patch(
        "fastapi_auth.routers.password.PasswordService.forgot_password",
...
def test_password_status():
    ...
    with mock.patch(
        "fastapi_auth.routers.password.PasswordService.password_status",
        mock.AsyncMock(return_value=None),
    ) as mock_method:
...
def test_password_set():
    ...
    with mock.patch(
        "fastapi_auth.routers.password.PasswordService.password_set",
        mock.AsyncMock(return_value=None),
    ) as mock_method:
        response = test_client.post(
            url,
...
def test_password_reset():
    ...
    with mock.patch(
        "fastapi_auth.routers.password.PasswordService.password_reset",
        mock.AsyncMock(return_value=None),
    ) as mock_method:
        response = test_client.post(
            url,
...
def test_password_change():
    ...
    with mock.patch(
        "fastapi_auth.routers.password.PasswordService.password_change",
        mock.AsyncMock(return_value=None),
    ) as mock_method:
